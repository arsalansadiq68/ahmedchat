  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section id="visit" className="visit-section dark-section"><div className="page-width"><Reveal><SectionLabel dark>FIND AHMED BHAI</SectionLabel><h2>VISIT AHMED<br /><em>SAMOSA CHAAT HOUSE</em></h2></Reveal><div className="visit-layout"><Reveal delay={0.1}><div className="visit-details"><span className="visit-kicker">AHMED SAMOSA CHAAT HOUSE</span><div className="detail-line"><MapPin size={21} /><p>V4W8+X4Q, Gulshan-e-Jamal (Railway Colony),<br />Block D, Gulshan-e-Jamal, Karachi, Pakistan</p></div><div className="detail-line"><Phone size={20} /><a href={PHONE}>0336 1125871</a></div><div className="visit-actions"><a href={WHATSAPP} target="_blank" rel="noreferrer" className="button button-yellow"><MessageCircle size={18} /> WHATSAPP AHMED BHAI</a><a href={PHONE} className="button button-outline"><Phone size={17} /> CALL AHMED BHAI</a></div></div></Reveal><Reveal delay={0.2}><div className="map-card actual-map-card"><iframe title="Ahmed Samosa Chaat House location map" src="https://www.google.com/maps?q=V4W8%2BX4Q%2C%20Gulshan-e-Jamal%20(Railway%20Colony)%2C%20Block%20D%2C%20Gulshan-e-Jamal%2C%20Karachi%2C%20Pakistan&output=embed" loading="lazy" allowFullScreen referrerPolicy="no-referrer-when-downgrade" /><div className="map-caption"><div><MapPin size={18} /><div><strong>AHMED SAMOSA CHAAT HOUSE</strong><span>V4W8+X4Q, Gulshan-e-Jamal (Railway Colony), Block D, Gulshan-e-Jamal, Karachi</span></div></div><div className="map-actions"><a href={MAPS} target="_blank" rel="noreferrer" className="button button-yellow">GET DIRECTIONS <ArrowUpRight size={16} /></a><a href={PHONE} className="button button-outline">CALL AHMED BHAI</a><a href={WHATSAPP} target="_blank" rel="noreferrer" className="button button-outline">WHATSAPP AHMED BHAI</a></div></div></div></Reveal></div></div></section>
      </main>
